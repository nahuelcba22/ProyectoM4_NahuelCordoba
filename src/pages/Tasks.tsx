...
function Tasks() {
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.message || 'No se pudo enviar el email.',
        )
      }
  ...
  return (
    <main className="tasks-page">
      <div className="tasks-layout">
          ...
          <div className="tasks-title">
            <div>
              <h1 className="tasks-page-title">
                <span className="logo-mi">
                  Mi
                </span>

                <span className="logo-tarea">
                  tarea
                </span>
              </h1>

              <p>
                Organizá y gestioná tus tareas.
              </p>
            </div>
          </div>
        ...
        <button
          type="button"
          className="email-float-button"
          onClick={handleSendEmail}
          disabled={
            emailLoading ||
            tasks.length === 0
          }
          aria-label="Enviar resumen por email"
        >
          <span className="email-icon">
            ✉
          </span>

          <span className="email-float-label">
            {emailLoading
              ? 'Enviando...'
              : 'Enviar resumen'}
          </span>
